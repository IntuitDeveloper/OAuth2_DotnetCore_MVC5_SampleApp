    ...
    public class Startup
    {
        ...
        options.UseSqlServer(Configuration["DBConnectionString"]));
            services.AddIdentity<ApplicationUser, IdentityRole>()
               .AddEntityFrameworkStores<tokensContext>()
            ...
            {
                sharedOptions.DefaultChallengeScheme = "QB";
            })
               .AddCookie()
               .AddOAuth("QB",options =>
               {
                   options.ClientId = Configuration["OAuth2Keys:ClientId"];
                   options.ClientSecret = Configuration["OAuth2Keys:ClientSecret"];
                   options.CallbackPath = new PathString("/");
                   options.AuthorizationEndpoint = URL.AuthURL;
                   options.TokenEndpoint = URL.AuthURL;
